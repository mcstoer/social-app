    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join VerusSky`)}
              onPress={onJoinPress}
              variant="solid"
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join VerusSky</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.TitleText>
          <Trans>Download VerusSky</Trans>
        </Prompt.TitleText>
        <Prompt.DescriptionText>
          <Trans>
            The experience is better in the app. Download VerusSky now and we'll
      ...
      <View style={[a.flex_1, a.px_lg, {marginTop: 250}]}>
        ...
        <View style={[a.gap_md, {zIndex: 2}]}>
          <Text
            ...
            Download VerusSky to get started!
          </Text>
