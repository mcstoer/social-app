...
export const VerusIcon = React.forwardRef<Svg, Props>(
  function VerusIconImpl(props, ref) {
    ...
    return (
      <Svg
        ...
        <G clipPath="url(#clip0_1_20)">
          <Path
            d="M100.5 201C156.005 201 201 156.005 201 100.5C201 44.9954 156.005 0 100.5 0C44.9954 0 0 44.9954 0 100.5C0 156.005 44.9954 201 100.5 201Z"
            fill="white"
          />
          <Path
            fillRule="evenodd"
