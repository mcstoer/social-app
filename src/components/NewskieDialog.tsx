  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined VerusSky using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined VerusSky ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined VerusSky using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined VerusSky ${timeAgoString} ago`)
      }
    }
  }
